          ...
          <Col className="side-bar-practice" xs lg="2">
            ...
            <Stack>
              <div className="ques-sec ">
                ...
                <p>Why investment banking versus sales and trading?</p>
                <a href="#">
                  <img src={edit} alt="" />
                </a>
                <a href="#">
            ...
            <Form className="add-question-form">
              <Form.Group className="mb-3" controlId="formGroupEmail">
                <Form.Control type="text" placeholder=" Type in a Question" />
              </Form.Group>
          ...
          <Col>
            <div className="video-side">
              <div className="heading-sec">
                <h1>Why investment banking versus sales and trading?</h1>
              </div>
